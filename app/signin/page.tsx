...
function SignInForm() {
  ...
  const handleSendOTP = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (otpError) {
        if (otpError.message.includes("not found") || otpError.message.includes("User not found")) {
          ...
          <div className="space-y-4 mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-white px-4 text-gray-500">Or sign in with mobile number</span>
              </div>
            </div>
